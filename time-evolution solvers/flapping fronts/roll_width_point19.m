clc
clear
filepath=strcat(pwd,'/roll_width_point19');
N=5000;
filenamev='roll_width_point19';
...
for i=1:N
    ...
    t = annotation('textbox','String','$F=6$, $H_-=0.28$ width is $0.19$','Interpreter','latex','EdgeColor','none');
    t.FontSize=20;
