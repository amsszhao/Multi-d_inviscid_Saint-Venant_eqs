clc
clear
filepath=strcat(pwd,'\roll_width_point17');
N=5001;
filenamev='roll_width_point17';
hn=0.28;
f=6;
num_mesh=800;
num_period=10;
...
for i=1:N
    ...
    t = annotation('textbox','String','$F=6$, $H_-=0.28$ width is $0.17$','Interpreter','latex','EdgeColor','none');
    t.FontSize=20;
